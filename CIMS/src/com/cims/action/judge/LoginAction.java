...
public class LoginAction extends BaseAction{
	...
	@Action(value="login", results={@Result(name="input",location="/WEB-INF/content/judge/login.jsp"),
	...
	public String login(){
		if(customValidate()){
			...
			sessionMap.put(ActionContant.session_judge, judge);
...
//	}
	...
	public String logout(){
		sessionMap.remove(ActionContant.session_judge);
		return SUCCESS;
	}
